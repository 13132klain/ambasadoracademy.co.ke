        ...
        <div className="text-center py-4">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              onClick={() => { 
                const link = document.createElement('a');
                link.href = '//home/kevinklein/Downloads/Ambassador Academy-20250626T211602Z-1-001/Ambassador Academy/public/fee-structures/BOARDING JUNIOR SCHOOL FEES STRUCTURE  2025.pdf';
